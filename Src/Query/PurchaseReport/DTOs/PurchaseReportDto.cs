...
namespace Query.PurchaseReport.DTOs
{
    ...
    //public class PurchaseReportProfitResult : BaseFilter<UserPurchaseReportDto, UserPurchaseReportFilterParam>
    //{
    ...
    public class ProductProfitPurchaseReportDto : BaseDto
    {
        ...
        public string ImageName { get; set; }
        public InventoryDto InventoryDto { get; set; }
        public List<PaidProfit> Paid { get; set; } = new();
        public List<UnpaidProfit> Unpaid { get; set; } = new();
